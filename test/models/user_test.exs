defmodule Scrumapi.UserTest do
  use Scrumapi.ModelCase

  alias Scrumapi.User

  @valid_attrs %{email: "bar@baz.com", password: "somes3cr3t"}
  @invalid_attrs %{}
  ...
  test "changeset, email invalid format" do
    changeset = User.changeset(
      %User{},
      Map.put(@valid_attrs, :email, "badfor.mat"))
    refute changeset.valid?
  end

  test "registration_chageset, password ok" do
